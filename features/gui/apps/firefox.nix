...
#          bypass-paywalls-clean
        ...
        settings = {
           ...
           "media.eme.enabled" = false;                             # Disables playback of DRM-controlled HTML5 content otherwise automatically downloads the Widevine Content Decryption Module provided by Google Inc.
           "media.gmp-widevinecdm.enabled" = false;                 # Disables the Widevine Content Decryption Module provided by Google Inc. Used for the playback of DRM-controlled HTML5 content Details (https://support.mozilla.org/en-US/kb/enable-drm#w_disable-the-google-widevine-cdm-without-uninstalling)
