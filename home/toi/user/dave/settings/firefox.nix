...
{
  config = {
    host.home.applications.firefox.defaultSettings.enable = mkDefault true;
      ...
      profiles.default = {
        ...
        userChrome = ''
          ...
          :root {
            ...
            --tab_close_icons_size: 16px !important;
            /* 14-20px */
            ...
            --bookmark_items_height: 22px !important;
            /* <- bookmark items - line height */
            ...
            --results_font_size: var(--general_ui_font_size, 10pt) !important;
            /* 10pt */
            ...
            --top_toolbars_background: hsl(235, 33%, 19%) !important;
            /* #0063b1 */
            /* hsl(235,33%,19%) was used by old accent color option  */
            --top_toolbars_background_inactive: hsl(235, 13%, 9%) !important;
            /* #ffffff */
        ...
        */
          ...
          /* default colors */
          :root {
            --general_toolbar_color_toolbars: linear-gradient(
              #f9f9fa,
              #f9f9fa
            ) !important;
            /* (to bottom,#FFCC99,#FFCC99) */
            ...
            --tabs_toolbar_color_tabs_not_on_top: linear-gradient(
              #f9f9fa,
              #f9f9fa
            ) !important;
            /* (to bottom,#FFCC99,#FFCC99) */
            ...
            --colored_menubar_background_image: linear-gradient(
              #f9f9fa,
              #f9f9fa
            ) !important;
            /* (to bottom,#FFCC99,#FFCC99) */
            ...
            /* tab colors
                          */
            --classic_squared_tabs_active_tab: linear-gradient(
              to top,
              #f9f9fa,
              #f9f9fa,
              #f9f9fa
            ) !important;
            /* (to bottom,#FF8800,#FFCC99) */
            --classic_squared_tabs_hovered_tabs: linear-gradient(
              to top,
              #cac7c1,
              #d5d2cc,
              #e8e6e2
            ) !important;
            /* (to bottom,#FF9900,#FF6600) */
            --classic_squared_tabs_other_tabs: linear-gradient(
              to top,
              #aeaba5,
              #c1beb7,
              #c9c6be
            ) !important;
            /* (to bottom,#FFCC99,#CCCCCC) */
            --classic_squared_tabs_unloaded_tabs: linear-gradient(
              to top,
              #aeaba5,
              #c1beb7,
              #c9c6be
            ...
            --classic_squared_tabs-border2: rgba(0, 0, 0, 0.2) !important;
            --classic_squared_tabs-border3: rgba(0, 0, 0, 0.5) !important;
            ...
            /* tab colors - dark text, but bright themes:
                          */
            --classic_squared_tabs_lwt-dark_active_tab: inherit !important;
            /* linear-gradient(blue, hsla(0,0%,60%,.5) 80%) */
            --classic_squared_tabs_lwt-dark_hovered_tabs: linear-gradient(
              hsla(0, 0%, 80%, 0.5),
              hsla(0, 0%, 60%, 0.5) 80%
            ) !important;
            --classic_squared_tabs_lwt-dark_other_tabs: linear-gradient(
              hsla(0, 0%, 60%, 0.5),
              hsla(0, 0%, 45%, 0.5) 80%
            ) !important;
            ...
            /* tab colors - bright text, but dark themes:
                          */
            --classic_squared_tabs_lwt-bright_hovered_tabs: linear-gradient(
              hsla(0, 0%, 60%, 0.6),
              hsla(0, 0%, 45%, 0.6) 80%
            ) !important;
            --classic_squared_tabs_lwt-bright_other_tabs: linear-gradient(
              hsla(0, 0%, 40%, 0.6),
              hsla(0, 0%, 30%, 0.6) 80%
            ) !important;
            --classic_squared_tabs_lwt-bright_active_tab: inherit !important;
            /* linear-gradient(blue, hsla(0,0%,60%,.5) 80%) */
          }
          ...
          #main-window:not(
            ...
            ):-moz-lwtheme:-moz-lwtheme-brighttext
            :is(
              #containers-panelmenu,
              #web-apps-button,
              #e10s-button,
          ...
          @media (-moz-content-prefers-color-scheme: dark) {
            #main-window:not([style*="--lwt-header-image"]):-moz-lwtheme
              :is(
                #containers-panelmenu,
                #web-apps-button,
                #e10s-button,
          ...
          /*ROYAL BLUE*/
          toolbar:not(#TabsToolbar):not(:-moz-lwtheme)
            :is(.scrollbutton-up, .scrollbutton-down, #new-tab-button, #alltabs-button),
          #downloads-button[indicator="true"]:not([attention="success"])
          ...
          #fxa-manage-account-button::before {
            ...
            -moz-context-properties: fill;
            background-image: url("chrome://browser/skin/fxa/avatar.svg") !important;
            /* tab.svg */
          ...
          #PanelUI-history
            :is(#appMenuRestoreSession, #appMenu-restoreSession)
            > .toolbarbutton-icon {
            -moz-context-properties: fill;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_toggleToolbox"]:not([checked="true"])
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_inspector"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_webconsole"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_toggleToolbox"]
            + toolbarbutton
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_netmonitor"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_styleeditor"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_performance"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_accessibility"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_application"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
          ...
          #appmenu-developer-tools-view
            toolbarbutton[key="key_browserConsole"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
            list-style-image: url("chrome://devtools/skin/images/tool-webconsole.svg");
          ...
          #appmenu-developer-tools-view
            ...
            > image.toolbarbutton-icon {
            /* Re-using the DOM icon since I expect everyone uses the Inspector instead */
            -moz-context-properties: fill;
            fill: currentColor;
            list-style-image: url("chrome://devtools/skin/images/tool-dom.svg");
          }
          ...
          #appmenu-developer-tools-view
            toolbarbutton[data-l10n-id="appmenu-developer-tools-extensions"]
            > image.toolbarbutton-icon {
            -moz-context-properties: fill;
            fill: currentColor;
            list-style-image: url("chrome://mozapps/skin/extensions/extension.svg");
          ...
          #main-window:-moz-lwtheme:-moz-lwtheme-brighttext
            #appmenu-developer-tools-view
            toolbarbutton[key="key_toggleToolbox"]:not([checked="true"])
            > image.toolbarbutton-icon,
          #main-window:-moz-lwtheme:-moz-lwtheme-brighttext
          ...
          #main-window:-moz-lwtheme:-moz-lwtheme-brighttext
            #appmenu-developer-tools-view
            toolbarbutton[key="key_jsdebugger"]
            > image.toolbarbutton-icon,
          #main-window:-moz-lwtheme:-moz-lwtheme-brighttext
            #appmenu-developer-tools-view
            toolbarbutton[key="key_netmonitor"]
          ...
          #appmenu-developer-tools-view
            toolbarbutton:-moz-lwtheme-brighttext[key="key_toggleToolbox"]
            + toolbarbutton
            + toolbarbutton
            + toolbarbutton
            > image.toolbarbutton-icon,
          ...
          :is(#appMenu-zoom-controls, #appMenu-zoom-controls2)::before,
          #PanelUI-bookmarks
            :is(#panelMenuBookmarkThisPage, #panelMenu_searchBookmarks)
            > .toolbarbutton-icon {
            fill: #336699 !important;
          }
          ...
          /* grey */
          :is(#appMenu-settings-button, #PanelUI-fxa-menu-setup-sync-button)
            > .toolbarbutton-icon {
            fill: grey !important;
          }
          ...
          #main-window[uidensity="compact"][tabsintitlebar][sizemode="maximized"]
            #toolbar-menubar {
          ...
          #main-window[uidensity="compact"][tabsintitlebar]
            #toolbar-menubar[autohide="true"][inactive="true"]
            ~ #TabsToolbar {
          ...
          #main-window[tabsintitlebar]:not([sizemode="fullscreen"])
          ...
          @media (not (-moz-os-version: windows-win10)) and (not (-moz-os-version: windows-win8)) and (not (-moz-os-version: windows-win7)) {
            #main-window[tabsintitlebar] #PanelUI-button #PanelUI-menu-button {
             ...
             #main-window[tabsintitlebar][sizemode="fullscreen"]
               #navigator-toolbox[style*="margin-top: -"]
               #PanelUI-button {
             ...
             /* 'DevFox' title */
             #main-window[tabsintitlebar]
               #PanelUI-menu-button[label="Firefox Developer Edition"]::after {
               content: "DevFox" !important;
             }

             /* 'Nightly' title */
             #main-window[tabsintitlebar]
               #PanelUI-menu-button:is([label="Nightly"], [label="Firefox Nightly"])::after {
               content: "Nightly" !important;
             }

             /* adjust button badge stack */
             #main-window[tabsintitlebar]
               :is(#PanelUI-button, #PanelUI-menu-button):not([checked], [open], :active)
               > .toolbarbutton-badge-stack,
             #main-window[tabsintitlebar]
               :is(#PanelUI-button, #PanelUI-menu-button):not(
                 [disabled="true"],
                 [checked],
                 [open],
                 :active
               ...
               > .toolbarbutton-badge-stack,
             #main-window[tabsintitlebar]
               :is(#PanelUI-button, #PanelUI-menu-button):not([disabled="true"]):is(
                 [open],
                 [checked],
                 :hover:active
               )
             ...
             #main-window[tabsintitlebar] #PanelUI-button #PanelUI-menu-button {
               ...
               border-right-color: hsla(214, 89%, 21%, 0.5) !important;
               border-left-color: hsla(214, 89%, 21%, 0.5) !important;
               border-bottom-color: hsla(214, 89%, 21%, 0.5) !important;
               box-shadow: 0 1px 0 hsla(0, 0%, 100%, 0.2) inset,
                 0 0 2px 1px hsla(0, 0%, 100%, 0.25) inset,
                 0 1px 0 0px rgba(255, 255, 255, 0.6), 0 -1px 0 0px rgba(255, 255, 255, 0.6),
                 1px 0 0 0px rgba(255, 255, 255, 0.6), -1px 0 0 0px rgba(255, 255, 255, 0.6) !important;
             }
             ...
             #main-window[tabsintitlebar]
               ...
               background-image: radial-gradient(
                   ...
                   rgba(252, 240, 89, 0.5) 10%,
                   rgba(252, 240, 89, 0) 70%
                 ),
                 radial-gradient(
                   farthest-side at center bottom,
                   rgb(236, 133, 0),
               ...
               border-color: rgba(83, 42, 6, 0.9) !important;
               box-shadow: 0 1px 0 hsla(0, 0%, 100%, 0.15) inset,
                 0 0 2px 1px hsla(0, 0%, 100%, 0.5) inset, 0 -1px 0 hsla(0, 0%, 100%, 0.2),
                 0 1px 0 0px rgba(255, 255, 255, 0.6), 0 -1px 0 0px rgba(255, 255, 255, 0.6),
                 1px 0 0 0px rgba(255, 255, 255, 0.6), -1px 0 0 0px rgba(255, 255, 255, 0.6) !important;
             }
             ...
             #main-window[tabsintitlebar]
               #PanelUI-button
               #PanelUI-menu-button:is(:hover:active, [open]) {
               background-image: linear-gradient(
                 rgb(246, 170, 69),
                 rgb(209, 74, 0) 95%
               ) !important;
               box-shadow: 0 2px 3px rgba(0, 0, 0, 0.4) inset,
                 0 1px 1px rgba(0, 0, 0, 0.2) inset, 0 1px 0 0px rgba(255, 255, 255, 0.6),
                 0 -1px 0 0px rgba(255, 255, 255, 0.6), 1px 0 0 0px rgba(255, 255, 255, 0.6),
                 -1px 0 0 0px rgba(255, 255, 255, 0.6) !important;
             }
             ...
             #main-window[privatebrowsingmode="temporary"][tabsintitlebar]
               ...
               background-image: radial-gradient(
                   farthest-side at center bottom,
                   rgba(240, 193, 255, 0.5) 10%,
                   rgba(240, 193, 255, 0) 70%
                 ),
                 radial-gradient(
                   farthest-side at center bottom,
                   rgb(192, 81, 247),
             ...
             #main-window[tabsintitlebar][uidensity="compact"]
               #PanelUI-menu-button
               .toolbarbutton-badge-stack,
             #main-window[tabsintitlebar]:not([uidensity="compact"]):not([uidensity="touch"])
               #PanelUI-menu-button
               .toolbarbutton-badge-stack,
             #main-window[tabsintitlebar][uidensity="touch"]
               #PanelUI-menu-button
               .toolbarbutton-badge-stack {
             ...
             #main-window[tabsintitlebar]
               toolbox
               toolbar:not(#TabsToolbar)
               #PanelUI-menu-button:not([type="menu-button"])
               .toolbarbutton-text,
             #main-window[tabsintitlebar]
               toolbox
               toolbar:not(#TabsToolbar)
             ...
             #main-window[tabsintitlebar]
               ...
               toolbar:not(#TabsToolbar)
               toolbaritem
               #PanelUI-menu-button:not(#nav-bar-overflow-button):not(#PlacesChevron)
               > :is(.toolbarbutton-icon, .toolbarbutton-badge-stack),
             #main-window[tabsintitlebar]
               toolbox
               toolbar:not(#TabsToolbar)
               #PanelUI-menu-button:not([type="menu-button"]):not(
                 #nav-bar-overflow-button
               ):not(#PlacesChevron)
               > :is(.toolbarbutton-icon, .toolbarbutton-badge-stack) {
               opacity: 1 !important;
             ...
             */
             ...
             #main-window[tabsintitlebar]
               #PanelUI-button
               #PanelUI-menu-button[label="Firefox Developer Edition"]:hover:not(
                 :active
               ):not([open]) {
               background-image: radial-gradient(
                   farthest-side at center bottom,
                   hsla(202, 100%, 85%, 0.5) 10%,
                   hsla(202, 100%, 85%, 0) 70%
                 ),
                 radial-gradient(
                   farthest-side at center bottom,
                   hsla(205, 100%, 72%, 0.7),
             ...
             #main-window[tabsintitlebar]
               #PanelUI-button
               #PanelUI-menu-button[label="Firefox Developer Edition"]:is(
                 :hover:active,
                 [open]
               ) {
               background-image: linear-gradient(
             ...
             #main-window[tabsintitlebar]
               #PanelUI-button
               #PanelUI-menu-button:is([label="Nightly"], [label="Firefox Nightly"]) {
               background-image: linear-gradient(
                 hsl(211, 33%, 32%),
                 hsl(209, 53%, 10%) 95%
               ) !important;
             ...
             #main-window[tabsintitlebar]
               #PanelUI-button
               #PanelUI-menu-button:is(
                 [label="Nightly"],
                 [label="Firefox Nightly"]
               ):hover:not(:active):not([open]) {
               background-image: radial-gradient(
                   farthest-side at center bottom,
                   hsla(210, 48%, 90%, 0.5) 10%,
                   hsla(210, 48%, 90%, 0) 70%
                 ),
                 radial-gradient(
                   farthest-side at center bottom,
             ...
             #main-window[tabsintitlebar]
               #PanelUI-button
               #PanelUI-menu-button:is([label="Nightly"], [label="Firefox Nightly"]):is(
                 :hover:active,
                 [open]
               ) {
               background-image: linear-gradient(
             ...
             #main-window[tabsintitlebar]
               #navigator-toolbox
               #PanelUI-button
               #PanelUI-menu-button:is([label="Tor Browser"], [label="Tor-Browser"]) {
               background-image: linear-gradient(
                 rgb(153, 38, 211),
                 rgb(105, 19, 163) 95%
               ) !important;
             ...
             #main-window[tabsintitlebar]
               #navigator-toolbox
               #PanelUI-button
               #PanelUI-menu-button:is([label="Tor Browser"], [label="Tor-Browser"]):is(
                 :hover:active,
                 [open]
               ) {
               background-image: linear-gradient(
             ...
             :root {
               ...
               --classic_squared_tabs-border2: rgba(0, 0, 0, 0.2);
               --classic_squared_tabs-border3: rgba(0, 0, 0, 0.5);
               ...
               --mltabs-newtab-height: calc(
                 var(--classic_squared_tabs_tab_height) + 1px
               ) !important;
               --tab-min-height_tnot: calc(
                 var(--classic_squared_tabs_tab_height) - 1px
               ) !important;
               /* for tabs_below_navigation_toolbar_alt.css */

               --tab_below_navigation_toolbar_bottom_padding: var(
                 --classic_squared_tabs_tab_height
               ) !important;

               --tab_below_main_content_bottom_margin: calc(
                 2px + var(--classic_squared_tabs_tab_height)
               ) !important;
               --tab_below_main_content_toolbar_height: calc(
                 1px + var(--classic_squared_tabs_tab_height)
               ) !important;
               --tab_below_main_content_top_margin: 0 !important;

               /* variables for tabs below navigation toolbar option on macOS */
               --tab_below_navigation_toolbar_bottom_padding_macOS: var(
               --classic_squared_tabs_tab_height
             ) !important;
             --tab_below_navigation_toolbar_toolbox_top_padding_macOS: calc(
               -2px + var(--classic_squared_tabs_tab_height)
             ) !important;
           ...
           #TabsToolbar:not(:-moz-lwtheme) :is(.tabs-newtab-button, #tabs-newtab-button),
           #TabsToolbar:not(:-moz-lwtheme) .tabbrowser-tab .tab-content {
             border-top: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border1) !important;
             border-left: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border1) !important;
             border-right: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border1) !important;
           }

           #TabsToolbar :is(.tabs-newtab-button, #tabs-newtab-button) {
             border-top: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border2) !important;
             border-left: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border2) !important;
             border-right: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border2) !important;
           ...
           #TabsToolbar
             .tabbrowser-tab:not(:-moz-lwtheme):not([selected], [multiselected])
             .tab-content {
             border-top: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border3) !important;
             border-left: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border3) !important;
             border-right: var(--classic_squared_tabs-border_size) solid
               var(--classic_squared_tabs-border3) !important;
           ...
           /* lightweight theme tab colors*/
           #TabsToolbar:is([darktext], :-moz-lwtheme-darktext):-moz-lwtheme
           ...
           #TabsToolbar:not([selected], [multiselected]):-moz-lwtheme-darktext:-moz-lwtheme
             .tabbrowser-tab
             .tab-content {
           ...
           #TabsToolbar:is([darktext], :-moz-lwtheme-darktext):-moz-lwtheme
             ...
             background-image: var(
               --classic_squared_tabs_lwt-dark_hovered_tabs
             ) !important;
           }

           #TabsToolbar:is([brighttext], :-moz-lwtheme-brighttext):-moz-lwtheme
             .tabbrowser-tab:is([selected], [multiselected])
             .tab-content {
             background-image: var(
               --classic_squared_tabs_lwt-bright_active_tab
             ) !important;
           }
           ...
           #TabsToolbar:is([brighttext], :-moz-lwtheme-brighttext):-moz-lwtheme
             ...
             .tab-content {
             background-image: var(
               --classic_squared_tabs_lwt-bright_other_tabs
             ) !important;
           }
           ...
           #TabsToolbar:is([brighttext], :-moz-lwtheme-brighttext):-moz-lwtheme
             ...
             .tab-content {
             background-image: var(
               --classic_squared_tabs_lwt-bright_hovered_tabs
             ) !important;
           }

           #TabsToolbar:is([brighttext], :-moz-lwtheme-brighttext):-moz-lwtheme
             .tabbrowser-tab:not([selected], [multiselected]):not(:hover) {
             background: unset !important;
           }
           ...
           @media (-moz-content-prefers-color-scheme: dark) {
             ...
             .tabbrowser-tab:not([selected], [multiselected]):hover:-moz-lwtheme
               .tab-content {
               background-image: var(
                 --classic_squared_tabs_lwt-bright_hovered_tabs
               ) !important;
           ...
           @media (-moz-content-prefers-color-scheme: light) {
             .tabbrowser-tab:is([selected], [multiselected]):-moz-lwtheme .tab-content {
               background-image: var(
                 --classic_squared_tabs_lwt-dark_active_tab
               ) !important;
             }
             ...
             .tabbrowser-tab:not([selected], [multiselected]):-moz-lwtheme .tab-content {
               background-image: var(
                 --classic_squared_tabs_lwt-dark_other_tabs
               ) !important;
             }
           ...
           .tabbrowser-tab:-moz-lwtheme:is([selected], [multiselected])
             .tab-line:is([selected], [multiselected]) {
           ...
           .tabbrowser-tab:hover
             > .tab-stack
             > .tab-background
             > .tab-line:not([selected], [multiselected]) {
           ...
           #TabsToolbar:not(:-moz-lwtheme)
             ...
             --tab-loading-fill: var(
               --classic_squared_tabs_tab_default_loading_icon_color
             ) !important;
           }
           ...
           .tabbrowser-tab:not([selected]):not([afterselected-visible]):not(
               [afterhovered]
             ):not([first-visible-tab]):not(:hover)::before,
           #tabbrowser-tabs:not([overflow])
             > .tabbrowser-tab[last-visible-tab]:not([selected], [multiselected]):not(
               [beforehovered]
             ):not(:hover)::after {
           ...
           .tabbrowser-tab[selected]:not(:hover)
             .tab-label-container:not([labeldirection="rtl"]),
           #tabbrowser-tabs:not([closebuttons="activetab"])
           ...
           #main-window:not([lwtheme-image="true"])
             #tabbrowser-tabs:not([movingtab])
             > #tabbrowser-arrowscrollbox
             > .tabbrowser-tab
             > .tab-stack
           ...
           #TabsToolbar
             #tabbrowser-tabs
             .tabbrowser-tab:not([pinned])[faviconized="true"]
             .tab-close-button {
             visibility: collapse !important;
             display: none !important;
           }
           ...
           */
           ...
           #editBMPanel_folderMenuList:-moz-any(
           ...
           #navigator-toolbox
             > toolbar:not(#toolbar-menubar):not(#TabsToolbar):not(#nav-bar) {
             padding-left: 0px !important;
             padding-right: 0px !important;
           }
           ...
           @media (not (-moz-os-version: windows-win10)) and (not (-moz-os-version: windows-win8)) and (not (-moz-os-version: windows-win7)) {
             #TabsToolbar
               .titlebar-placeholder[type="caption-buttons"]:not([ordinal="1000"]) {
           ...
           #main-window
             toolbar:not(:-moz-lwtheme):not(#TabsToolbar):not(#toolbar-menubar):not(
               #nav-bar
             ) {
             appearance: none !important;
           ...
           #main-window:not(:-moz-lwtheme)
             ...
             /* findbar */
             #main-window
               :is(.browserContainer, #viewSource):not(:-moz-lwtheme)
               :is(findbar, #FindToolbar) {
               background: var(--general_toolbar_color_toolbars, inherit) !important;
             }

             #main-window[style*="--lwt-header-image"]:-moz-lwtheme
               :is(.browserContainer, #viewSource)
               :is(findbar, #FindToolbar) {
             ...
             #urlbar[focused="true"][suppress-focus-border][open="true"]
             ...
             #urlbar
               ...
               .urlbarView-action,
             #urlbar
               .urlbarView-row:not([has-url="true"])
               .urlbarView-no-wrap
               .urlbarView-action {
