...
hash_md5()  { get_file_hash md5 "$1"; }
hash_sha1() { get_file_hash sha1 "$1"; }
hash_sha256() { get_file_hash sha256 "$1"; }
hash_sha384() { get_file_hash sha384 "$1"; }
hash_sha512() { get_file_hash sha512 "$1"; }
...
compress () {
  if [ $# -ge 2 ] ; then
      ...
      case $arg1 in
          ...
          *.7z)        7z a "$arg1" $arg2 ;;
          *.zst*)      zstd "$arg1" ;;
          *)           echo "don't know how to compress '$arg1'..." ;;
      esac
  else
